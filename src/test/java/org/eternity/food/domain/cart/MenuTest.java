...
public class MenuTest {
    ...
    public void 옵션그룹추가_중복이름_에러() {
        Menu menu = aMenu()
                        .groups(set(anOptionGroup().name("중복그룹").build()))
                        .build();
        try {
    ...
    public void 메뉴오픈_빈옵션그룹_에러() {
        Menu menu = aMenu().groups(Collections.emptySet()).build();
    ...
    public void 메뉴오픈_필수옵션그룹_없음_오류() {
        Menu menu = aMenu()
                        .groups(set((anOptionGroup().mandatory(false).build())))
                        .build();
    ...
    public void 메뉴오픈_필수옵션그룹_갯수초과_오류() {
        Menu menu = aMenu()
                        .groups(set(
                            anOptionGroup().id(1L).name("그룹1").mandatory(true).build(),
                            anOptionGroup().id(2L).name("그룹2").mandatory(true).build(),
                            anOptionGroup().id(3L).name("그룹3").mandatory(true).build(),
                            anOptionGroup().id(4L).name("그룹4").mandatory(true).build()))
                        .build();
    ...
    public void 메뉴오픈_금액설정_옵션그룹_미존재_오류() {
        Menu menu = aMenu()
                .groups(set(
                        anOptionGroup().id(1L).name("그룹1").mandatory(true).options(set(anOption().price(Money.ZERO).build())).build(),
                        anOptionGroup().id(2L).name("그룹2").mandatory(true).options(set(anOption().price(Money.ZERO).build())).build()))
                .build();
